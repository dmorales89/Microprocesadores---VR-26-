...
| Nombre | Matrícula |
|---|---|
| Luis Manuel Peña Angulo | 650204 |
| Diego Arturo Morales Resendez | 609255 |
...
Este repositorio contiene la documentación de las prácticas realizadas durante VR26 en la materia de **Microprocesadores**.

Cada práctica incluye:

- Imagen del circuito 
- Breve explicación del funcionamiento
- Código fuente utilizado para programar el PIC16F887
...
| Práctica 4 | [Ver práctica](Practicas/P04) |
| Práctica 5 | [Ver práctica](Practicas/P05) |
...
El PIC16F887 fue utilizado para desarrollar prácticas de entradas y salidas digitales, manejo de periféricos, lectura analógica, comunicación serial y control mediante programación en lenguaje C.
